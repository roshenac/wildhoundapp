...
<section class="install-gate" id="installGate" aria-live="polite">
  <div class="install-card">
    ...
    <ul class="guide-list">
      <li><strong>iPhone (Safari only):</strong> Open in Safari, tap Share, then <strong>Add to Home Screen</strong>.</li>
  ...
  <main>
    ...
    <section class="screen" id="settings">
      ...
      <details class="card highlight collapse-card" open>
        ...
        <div class="btn-row">
          <button type="button" class="btn-primary" id="openPackingGuideBtn">View Guide In App</button>
          <button type="button" class="btn-secondary" id="downloadPackingGuideBtn">Download PDF</button>
        </div>
      </details>
...
<nav class="bottom-nav">
  <a class="tab-btn" data-screen="dashboard" href="dashboard.html"><svg class="icon" viewBox="0 0 24 24"><path d="M3 11l9-7 9 7"></path><path d="M5 10v10h14V10"></path></svg>Home</a>
...
<div class="modal-backdrop" id="packingGuideModalBackdrop">
  <div class="modal">
    <h3>Trail Packing Guide</h3>
    <p class="muted">If the preview doesn't load on your device, use Download PDF.</p>
    <div class="card" style="padding: 0; overflow: hidden; margin-bottom: 10px;">
      <iframe
        id="packingGuideFrame"
        title="Wild Hound packing guide"
        src="about:blank"
        style="width: 100%; min-height: 72vh; border: 0; background: #fffdf8;"
        loading="lazy"
        referrerpolicy="no-referrer"
      ></iframe>
    </div>
    <div class="btn-row sticky-actions" style="margin-top: 0;">
      <button type="button" class="btn-primary" id="packingGuideDownloadFromModalBtn">Download PDF</button>
      <button type="button" class="btn-secondary" id="packingGuideCloseBtn">Close</button>
    </div>
  </div>
</div>
`;
